...
public class WinScreen extends GraphicsBuffer {
    private final Button rematchButton, titleScreenButton;
    ...
    public WinScreen(Main main, String renderer, int winnerNumber) {
        ...
        rematchButton = new Button.Builder(HALF_WIDTH, HALF_HEIGHT - buttonHeight / 2f - buttonMargin / 2f, buttonWidth, buttonHeight,
                PGraphics.CENTER, main::rematch)
                .text("Rematch")
                .hoverExpand(3)
                .build();
        titleScreenButton = new Button.Builder(HALF_WIDTH, HALF_HEIGHT + buttonHeight / 2f + buttonMargin / 2f, buttonWidth, buttonHeight,
                PGraphics.CENTER, main::exitToTitleScreen)
                .text("Title Screen")
                .hoverExpand(3)
                .build();
    }
